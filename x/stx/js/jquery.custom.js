(function($){
    ...
    $(document).ready(function(){
		...
		if( !device.tablet() && !device.mobile() ) {
			...
			$('#nodius-section').addClass('parallax-banner-3');
		...
		$('#to-intro-section').click( function(event) {
		...
		function animate_portfolio() {
			...
			$('.resources-section .portfolio-box').css('opacity' , 0).each(function( k ) {
		...
		function animate_sections() {
			...
			$('.wrap').waypoint(function(direction) {
				...
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					...
					setTimeout ( function () {
							$('#intro-section header').find('.section-title').animate({ opacity: 1 });
					}, 200 );
					
					setTimeout ( function () {
							$('#intro-section header').find('.section-slogan').animate({ opacity: 1 });
					}, 600 );
			...
			/* team section */
			$('#registry-of-deeds-section').waypoint( function( direction ) {
								
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					
					setTimeout ( function () {
							$('#registry-of-deeds-section header').find('.section-title').animate({ opacity: 1 });
					}, 200 );
					
					setTimeout ( function () {
							$('#registry-of-deeds-section header').find('.section-slogan').animate({ opacity: 1 });
					}, 600 );
			...
			$('#nodius-section').waypoint( function( direction ) {
								
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					
					setTimeout ( function () {
							$('#nodius-section header').find('.parallax-title').animate({ opacity: 1 });
					}, 200 );
					
					setTimeout ( function () {
							$('#nodius-section header').find('.parallax-slogan').animate({ opacity: 1 });
					}, 600 );
			...
			$('#strategy-section').waypoint( function( direction ) {
								
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					
					setTimeout ( function () {
							$('#strategy-section header').find('.parallax-title').animate({ opacity: 1 });
					}, 200 );
					
					setTimeout ( function () {
							$('#strategy-section header').find('.parallax-slogan').animate({ opacity: 1 });
					}, 600 );
			...
			$('#resources-section').waypoint( function( direction ) {
								
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					
					setTimeout ( function () {
							$('#resources-section header').find('.section-title').animate({ opacity: 1 }).addClass('animated');
					}, 200 );
					
					setTimeout ( function () {
							$('#resources-section header').find('.section-slogan').animate({ opacity: 1 }).addClass('animated');
					}, 600 );
